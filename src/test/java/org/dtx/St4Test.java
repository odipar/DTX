...
/**
 * DTX2 through a real ST4 packer, where one is beside this repository.
 *
 * <p>The packer is the executable at {@code ST4}, or {@code st4} on the
 * path. Without one the checks here are skipped: no ST4 code is kept here,
 * so nothing in the tree can stand in for it.
 */
final class St4Test {
    ...
    void aPackedTableRunsToFewerBytesThanTheColumnsItHolds() throws Exception {
        ...
        byte[] packed = Dtx2.from(plain, new St4(packer()), 1, 960);
