...
| ST4 | The packer a DTX2 column is packed with, specified in its own repository. A data set of it is packed at a unit `k` and unpacks through a ring of `N` bytes. | requirements.md R5, SPEC.md 2.3 |
